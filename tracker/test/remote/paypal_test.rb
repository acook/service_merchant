...
payment_options = { :subscription_name => 'Unsuccessful payment', :order => {:invoice_number => '032895'} }
recurring_options = {:start_date => Date.today + 1, :occurrences => 402, :interval => '1w' }
new_recurring_options = { :pay_on_day_x => 3 }
